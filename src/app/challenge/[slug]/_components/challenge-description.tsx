export default function ChallengeDescription() {
  return (
    ...
    >
      <div>
        <h2 className="text-xl font-bold text-main-primary mb-2">챌린지 소개</h2>
        <h3 className="text-text-primary mb-4 font-semibold text-xl">
          title
        </h3>
        <p>Michelle and Barack Obama gave resounding endorsements of Kamala
          Harris on Tuesday night at the Democratic National Convention.
        </p>
      </div>
      <div>
        <h2 className="text-xl font-bold text-main-primary mb-2">챌린지 미션</h2>
        <h3 className="text-text-primary mb-4 font-semibold text-xl">
          title
        </h3>
