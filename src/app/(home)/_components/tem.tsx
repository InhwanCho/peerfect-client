...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        'ml-2 bg-transparent outline-none placeholder:text-sm placeholder-gray-400 focus:outline-none focus:border-main-primary flex-1',
        className,
...
>(({ className, value, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      {children}
      {isIncluded && <SvgCheck className="size-4" />}
    </CommandItem>
  );
});
