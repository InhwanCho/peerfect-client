    ...
    <div className="w-full flex flex-col justify-evenly items-center h-[45vh]">
      ...
      <div className="w-full text-center">
        <div className="whitespace-nowrap text-sm mt-[110px] mb-16">
          ...
          <p className="text-[#9E9E9E] text-sm pt-2.5">10분 이내에 인증을 완료해주세요.</p>
        </div>
        <div className="w-full gap-y-4 flex flex-col">
          <button
            className="w-full bg-[#8530F1] text-white rounded-lg py-3 font-semibold h-[70px]"
          ...
          <button
            className="w-full text-[#9E9E9E] border rounded-lg py-3 font-semibold h-[70px]"
          >
            인증메일 재발송
          </button>
        </div>
